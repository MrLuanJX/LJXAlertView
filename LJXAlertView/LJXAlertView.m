...
@interface LJXAlertContentView : UIView

@property (nonatomic , strong) UILabel * lineLabel;

@property (nonatomic , strong) NSMutableArray * btnTitleArr;
/** 点击按钮回调 */
@property (copy, nonatomic) void (^buttonActionBlock) (UIButton *button);

@end

@implementation LJXAlertContentView
...
/** 视图 */
@property (nonatomic , strong) LJXAlertContentView * alertContentView;
...
- (instancetype)init{
    if (self = [super init]) {
        ...
        //弹出视图
        LJXAlertContentView * alertContentView = [[LJXAlertContentView alloc]init];
